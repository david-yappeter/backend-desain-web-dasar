...
func (l *UserLoaderByID) Load(key int) (*model.User, error) {
...
func (l *UserLoaderByID) LoadThunk(key int) func() (*model.User, error) {
	l.mu.Lock()
...
func (l *UserLoaderByID) LoadAll(keys []int) ([]*model.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoaderByID) LoadAllThunk(keys []int) func() ([]*model.User, []error) {
	results := make([]func() (*model.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoaderByID) Prime(key int, value *model.User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoaderByID) Clear(key int) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *UserLoaderByID) unsafeSet(key int, value *model.User) {
	if l.cache == nil {
...
func (b *userLoaderByIDBatch) keyIndex(l *UserLoaderByID, key int) int {
